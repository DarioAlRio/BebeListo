...
const HERO_LABELS = {
  "sillas-de-coche-para-bebe": "Silla de coche",
  "cochecitos-y-carritos-de-bebe": "Carrito",
  "tronas-para-bebe": "Trona",
  ...
  <section class="hero">
    <div class="wrap hero-inner">
      <div class="hero-copy">
        ...
        <h1>${SITE.claim}</h1>
        <p class="hero-dek">
          Comparamos criterios, no marcas: qué mirar antes de comprar una silla de coche, un
          carrito, una trona o un vigilabebés, explicado sin tecnicismos y sin recomendaciones
  ...
  <section class="section trust-section">
    <div class="wrap trust-grid">
      <div>
        ...
        <p>
          Elegir artículos de puericultura implica decidir sobre productos que tocan la
          seguridad y el descanso de un bebé que no puede opinar: una silla de coche mal
          elegida, un carrito demasiado pesado para tu día a día o una trona que no se limpia
          bien se notan justo cuando ya no hay margen para cambiar de opinión. ${SITE.name} reúne
          los criterios que importan de cada tipo de producto para que la decisión no dependa de
          adivinar ni de comparar precios sin más.
        </p>
        <p>
      ...
      <div class="trust-side">
        <img class="trust-photo" src="/assets/img/trust-bg.webp" alt="Padres con su bebé en casa" loading="lazy" width="480" height="480">
