...
const ARTICLES = [
  {
    ...
    body: [
      ...
      "Las guías de este sitio (sillas de coche, carritos, tronas, cunas de viaje, portabebés, monitores, esterilizadores, básculas, hamacas y termómetros/humidificadores) desarrollan cada categoría por separado con más detalle de criterios de compra, para cuando llegue el momento de decidir cada una con calma."
    ],
  },
  {
    ...
    updated: "2026-09-15",
    body: [
      "Comprar una silla de coche cara o bien valorada no garantiza una instalación y un uso correctos si se cometen algunos de estos errores habituales, todos evitables sin gastar más dinero.",
  ...
  },
  {
    ...
    body: [
      ...
      "Un orden razonable para la mayoría de familias: primero, un lugar seguro donde duerma (cuna, moisés o minicuna) con un colchón firme y adecuado a las medidas exactas de esa cuna, sin huecos laterales. Segundo, control de temperatura y humedad de la habitación (un termómetro ambiental sencillo y, si el clima de la zona lo justifica, un humidificador) para mantener un entorno cómodo para dormir. Tercero, si el presupuesto lo permite, un vigilabebés para poder estar en otra parte de la casa sin preocupación. Por último, mobiliario de almacenaje (cómoda, cesto de ropa) que puede completarse con calma, incluso con muebles que ya tengas en casa reutilizados.",
      "Un error habitual es sobrecargar la cuna con peluches, mantas sueltas o protectores acolchados de barrotes, elementos que las guías de prevención de muerte súbita del lactante recomiendan evitar en la cuna durante el sueño: la superficie debe quedar despejada, con el colchón firme como única base.",
  ...
  },
  {
    ...
    body: [
      ...
      "El primer salto importante, y el más rentable, está entre no invertir nada en seguridad y cubrir lo básico: una silla de coche homologada bien instalada y una cuna con colchón firme adecuado. Ese paso no es negociable y no depende del presupuesto: existen opciones seguras y homologadas en casi todos los rangos de precio, así que el gasto mínimo en estas dos categorías rara vez es la parte más cara del primer año.",
      "El segundo salto, ya opcional, está en la comodidad diaria: un carrito más ligero y fácil de plegar, una trona evolutiva que dure varios años en lugar de una clásica que se sustituye pronto, o un portabebés ergonómico bien ajustado. Este tramo compensa sobre todo si se va a usar el producto muy a menudo (el carrito o la trona, por ejemplo, se usan literalmente todos los días).",
      ...
      "La pregunta que más ayuda a decidir no es \"¿cuánto cuesta la mejor marca?\" sino \"¿qué voy a usar de verdad todos los días?\": priorizar el gasto ahí (carrito, trona, portabebés si porteas a menudo) suele dar mejor relación uso-precio que gastar más en productos de uso puntual."
    ],
  },
];
