...
const ARTICLE_GUIDES = {
  "que-necesitas-realmente-para-la-llegada-del-bebe": [
    "cochecitos-y-carritos-de-bebe",
    "sillas-de-coche-para-bebe"
  ],
  "errores-comunes-al-elegir-silla-de-coche": [
    "sillas-de-coche-para-bebe"
  ],
  "como-preparar-la-habitacion-del-bebe": [
    "monitores-y-vigilabebes",
    "termometros-y-humidificadores-para-bebe"
  ],
  "porteo-ergonomico-preguntas-frecuentes": [
    "portabebes-y-mochilas-ergonomicas"
  ],
  "cuanto-gastar-en-puericultura-el-primer-ano": [
    "sillas-de-coche-para-bebe",
    "cochecitos-y-carritos-de-bebe"
  ],
  "silla-de-coche-i-size-que-significa-realmente": [
    "sillas-de-coche-para-bebe"
  ],
  "cochecito-de-paseo-ciudad-o-todoterreno": [
    "cochecitos-y-carritos-de-bebe"
  ],
  "cuando-y-como-usar-un-monitor-de-video-para-bebes": [
    "monitores-y-vigilabebes"
  ],
  "portabebes-postura-correcta-y-edad-recomendada": [
    "portabebes-y-mochilas-ergonomicas"
  ],
  "para-que-sirve-realmente-una-bascula-de-bebe": [
    "basculas-de-bebe"
  ],
  "esterilizador-de-biberones-es-necesario": [
    "esterilizadores-y-calientabiberones"
  ],
  "hamaca-o-balancin-cuando-aporta-y-cuando-no": [
    "hamacas-y-balancines-para-bebe"
  ],
  "temperatura-y-humedad-en-la-habitacion-del-bebe": [
    "termometros-y-humidificadores-para-bebe"
  ],
  "cuna-de-viaje-o-cuna-fija-como-decidir": [
