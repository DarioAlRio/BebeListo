...
function head({ title, description, path, jsonLd = [], noindex = false }) {
  ...
  <link href="https://fonts.googleapis.com/css2?family=Fredoka:wght@500;600;700&family=Mulish:wght@400;500;600;700&display=swap" rel="stylesheet">
      ...
      <div class="foot-grid">
        <div class="foot-brand">
          ...
          <p class="foot-contact">
            ${icon("mail")}
            <a href="#" class="js-mail" data-correo="hola|bebelisto.es">activar JavaScript para ver el correo</a>
          </p>
        </div>
        ${columnas}
      </div>
...
function pageHero({ eyebrow, title, dek, updated, img, imgAlt }) {
  return `<section class="page-hero">
    ...
    ${img ? `<div class="page-hero-media"><img src="${img}" alt="${escapeHtml(imgAlt || title || "")}" loading="lazy" width="1200" height="500"></div>` : ""}
  </section>`;
}
...
function ctaBand() {
  return `<section class="cta-band">
    <div class="wrap">
      ...
      <p>Empieza por la guía que más te preocupe ahora mismo: silla de coche, carrito, trona o vigilabebés.</p>
